...
public class ArrayObj {
    public static void main(String[]args) {
        ...
        int antall = 0;
        double innPris = Double.parseDouble(JOptionPane.showInputDialog("Skriv inn prisen på filmen: "));
        ...
        while (antall < filmer.length && innPris > 0) {
            ...
            antall++;
             innPris = Double.parseDouble(JOptionPane.showInputDialog("Skriv inn prisen på filmen: "));
